    ...
    <div class="col-lg-6">
      <div class="card mt-5">
        <div class="card-body">
          ...
          <br>
          <!-- form validasi -->
          <form action="{{route('customer.registrasi')}}" method="POST">
            @csrf
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="number" name="no_hp"></input>
            </div>
            <div class="form-group">
            ...
            <p>Sudah memiliki akun? <a href="{{route('customer.login')}}">Login disini!</a></p>
          </form>
        </div>
      </div>
    </div>
